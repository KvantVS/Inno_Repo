...
#define MyAppLoaderName "Обновление Medins Doc"
#define MyAppLoaderExeName "MedinsLoader.exe"

#define ClientName "NEOTLOGKA_PND"
...
AppId={{24CEE0DC-5C5C-495D-A5F3-323307738C2F}}
AppName={#MyAppName}
...
OutputBaseFilename=MedinsPND_{#MyAppVersion}_{#ClientName}_server_setup
Compression=lzma
...
;Source: "Distr\LSEncrLib-Setup.exe"; DestDir: "{app}\OtherPackage"; Components: server client; Flags: ignoreversion
Source: "Distr\MedinsGuardian_PND_1.3.exe"; DestDir: "{app}\OtherPackage"; Components: server; Flags: ignoreversion
...
Source: "DBEngine.dll"; DestDir: "{app}";  Components: server; Flags: ignoreversion
Source: "DBCarSessions.dll"; DestDir: "{app}";  Components: server; Flags: ignoreversion
Source: "gds32.dll"; DestDir: "{app}";  Components: server; Flags: ignoreversion
Source: "libzmq.dll"; DestDir: "{app}";  Components: server; Flags: ignoreversion
Source: "Server.crt"; DestDir: "{app}";  Components: server; Flags: ignoreversion
Source: "Server.key"; DestDir: "{app}";  Components: server; Flags: ignoreversion
...
;Source: "Client.crt"; DestDir: "{app}";  Components: server client; Flags: ignoreversion
;Source: "Client.key"; DestDir: "{app}";  Components: server client; Flags: ignoreversion

; ================ SSL ===========================
Source: "ssleay32.dll"; DestDir: "{app}";  Components: server; Flags: ignoreversion
Source: "libeay32.dll"; DestDir: "{app}";  Components: server; Flags: ignoreversion
...
;Filename: "{app}\OtherPackage\LSEncrLib-Setup.exe"; Parameters: "/DIR=""{app}"" /VERYSILENT /SUPPRESSMSGBOXES"; Components: server client
