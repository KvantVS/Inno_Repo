...
AppId={{F5FCEA8B-60A6-4CCC-9D14-3A000D73CE2D}}
AppName={#MyAppName}
...
Source: "gds32.dll"; DestDir: "{app}";  Components: client; Flags: ignoreversion
...
Source: "MedinsLoader\{#ClientName}\MedinsLoader.ini"; DestDir: "{app}";  Components: client; Flags: ignoreversion
